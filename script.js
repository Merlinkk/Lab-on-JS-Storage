...
localStorage.clear() // to remove extra stuff/data that was there before
...
localStorage.setItem('first-name','Anshul')
localStorage.setItem('last-name','Kashyap')
localStorage.setItem('age','19')
localStorage.setItem('country','India')
localStorage.setItem('state','Himachal Pradesh')
